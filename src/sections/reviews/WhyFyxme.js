        ...
        <div className="row justify-content-center">
          <div className="col-lg-6 col-md-6 col-xl-6">
            ...
            <CardItem
              ...
              text="Don’t leave your car at a shop for days. We provide mobile
                bumper and body repair services at your home or office - 7
                days a week, saving you time and money."
            />
            <CardItem
              image="images/icons/ICONO4-01-min.png"
              alt="paint matchinh"
              title="Industry Best Paint with Lifetime Guarantee"
              text="Our advanced computerized PPG paint color matching and
                                  high-quality application system will ensure your original
                                  paints color."
            />
          </div>
          <div className="col-lg-6 col-md-6 col-xl-6">
            ...
            <CardItem
              ...
              text="We have partnered with the industry’s best suppliers to ensure
                                  the tools and products we use achieve the same results you
            ...
            <CardItem
              ...
              text="Our mobile car scratch repair technicians can touch up car
                paint and fix minor scrapes or deep scratches on car doors,
                hoods, bumpers, and fenders."
            />
          ...
          <div className="col-lg-6 col-md-6 col-xl-6">
            <CardItem
              ...
              text="If we can’t fix it, we will order bumper replacements and
                  other parts and install them at your location. Front bumper
                  replacement and rear bumper replacement costs vary depending
                  on the make, model, and severity of damage."
            />
            {/* <CardItem
